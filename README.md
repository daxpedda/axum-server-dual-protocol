...
[CHANGELOG]: https://github.com/daxpedda/axum-server-dual-protocol/blob/v0.4.0/CHANGELOG.md
[LICENSE-MIT]: https://github.com/daxpedda/axum-server-dual-protocol/blob/v0.4.0/LICENSE-MIT
[LICENSE-APACHE]: https://github.com/daxpedda/axum-server-dual-protocol/blob/v0.4.0/LICENSE-APACHE
[`axum`]: https://docs.rs/axum/0.6
[`axum-server`]: https://docs.rs/axum-server/0.5
[`bind_dual_protocol()`]: https://docs.rs/axum-server-dual-protocol/0.4/axum_server_dual_protocol/fn.bind_dual_protocol.html
...
[`ServerExt::set_upgrade()`]: https://docs.rs/axum-server-dual-protocol/0.4/axum_server_dual_protocol/trait.ServerExt.html#tymethod.set_upgrade
[`tower`]: https://docs.rs/tower/0.4
[`UpgradeHttpLayer`]: https://docs.rs/axum-server-dual-protocol/0.4/axum_server_dual_protocol/struct.UpgradeHttpLayer.html
